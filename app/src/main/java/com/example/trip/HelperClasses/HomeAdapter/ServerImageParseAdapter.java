...
public class ServerImageParseAdapter {
    ...
    public static com.example.trip.HelperClasses.HomeAdapter.ServerImageParseAdapter SIAdapter;
    ...
    public static com.example.trip.HelperClasses.HomeAdapter.ServerImageParseAdapter getInstance(Context SynchronizedContext) {

        if (SIAdapter == null) {

            SIAdapter = new com.example.trip.HelperClasses.HomeAdapter.ServerImageParseAdapter(SynchronizedContext);
        }
        return SIAdapter;
    }
